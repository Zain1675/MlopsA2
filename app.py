...
def dashboard():
    ...
    return render_template('dashboard.html', first_row=first_row_dict,Mean_Squared_Error=mse, Root_Mean_Squared_Error=rmse, Mean_Absolute_Error=mae, R_squared=r2)
